...
export default function SideNav() {
  ...
  return (
    <nav className="bg-[#BE121A] w-[10vw] flex flex-col items-center justify-between py-6">
      ...
      <div className="grid gap-4">
        ...
        {links.map((link, index) => {
          return (
            <div
              className="flex flex-col items-center gap-2 hover:text-shpccYellow hover:cursor-pointer"
              key={index}
            >
              {link.svg}
              <p>{link.link}</p>
