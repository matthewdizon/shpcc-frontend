          ...
          <div className="flex flex-wrap flex-col md:flex-row justify-between">
            ...
            <div className="flex flex-col md:flex-row md:gap-4">
              ...
              <button
                ...
                onClick={(e) => {
                  if (document.getElementById("contactNumber").validity.valid) {
                    e.preventDefault();
                    setShowModal(true);
                  }
                }}
                ...
                <div className="mt-6 text-gray-500 grid gap-2 text-left">
                  ...
                  <ol className="list-decimal ml-8 grid gap-2">
                    <li>
                      ...
                      SHPCC, at mga Resolusyong ipinasa ng Lupon ng Patnugutan
                      at aktibong lumahok sa mga pagpapasyang gagawin ng
                      Pangkalahatang Kapulungan.
                    </li>
                    <li>
                      Sakaling ako ay lumabag sa anumang batas na itinakda ng
                      SHPCC, tatanggapin ko ang kaparusahan na maaaring ipataw
                      sa akin tulad ng multa, suspensyon o pagpapatalsik bilang
                      kamay-ari. Ang aking lagak na puhunan ay pinapahintulot
                      kong maging panagot sa anumang natitirang obligasyon o
                    ...
                    <li>
                      ...
                      puhunan na hindi bababa sa 20 bahagi (shares) ng puhunan
                      na nagkakahalaga ng Php200.00/bahagi na may kabuuang
                      halagang P4,000.00; (c) Pagkakaloob ng saping puhunan na
                      hindi bababa sa 50% mula sa aking taunang interes at balik
                      tangkilik; (d) Pagbibigay ng awtorisasyon sa SHPCC na
                      awasin ang 2% mula sa aking utang upang idagdag sa aking
                      saping puhunan, 1% sa Guarantee Time Deposit (GTD) at 2%
                      para sa aking lagak na impok (savings deposit); (e)
                      Pag-ambag ng buwanan na hindi bababa sa 2% ng aking kita o
                      suweldo o sa P100.00 para sa Guarantee Time Deposit (GTD)
                      o Time Deposit;
                    </li>
                    <li>
                      Sa unang taon kinakailangan kong bayaran ng dalawang daan
                      at limampung piso (Php 250.00) bilang preferred share at
                      ito ay bibigyan ng interes batay sa ihahayag na interes ng
                      Lupon ng Patnugutan. Ang preferred share na ito ay
                      mananatili habang ako ay depositor ng kooperatiba.
                    </li>
                    <li>
                      Pagbayad ng ikalawang preferred share sa halagang dalawang
                      daan at limampung piso (P250.00) sa ikalawang taon ng
                      pagsapi at maaaring magiging regular na kasapi pagkatapos
                      ng dalawang taon.
                    </li>
                    <li>
                      Walang pasubali at di-mababawi na pangangalagaan ko ang
                      lahat ng mga lihim at “confidential” na impormasyon ng
                      SHPCC bilang pagsunod sa mga probisyon ng “Philippine Bank
                      Secrecy Laws” na nakasaad sa Batas Pambansa Blg. 1405,
                      6426 at 8791;
                    </li>
                    <li>
                  ...
                  <p>
                    ...
                    para sa Kooperasyon at Saligang Batas ng SHPCC ay
                    naipaliwanag sa akin at nauunawaan ko at ako ay
                    sumasang-ayon at nakahandang tuparin ang lahat ng ito.
                  </p>
                  <p>
                    Matapos basahin ang Kasunduang ito, nalalaman ko na ang
                    Lupon ng Patnugutan at ang pamunuan ng SHPCC ay maaari akong
                    patawan ng kaparusahan o gumawa ng anumang hakbanging
                    naaayon sa batas sakaling ako ay may nilabag sa anumang
                    probisyong nakasaad sa kasunduang ito na hindi na
                    kinakailangan pang idulog sa korte.
                  </p>
                </div>
              </TermsAndConditions>
            )}
